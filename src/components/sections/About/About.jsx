...
const About = () => {
	return (
		<section>
			<Container>
				<SimpleSection imageUrl="/images/banda/paisagem/banda_1.jpg" desc="Show da banda LastBones">
				...
				<SimpleSection right imageUrl="/images/show/show_8.jpg" desc="Pessoal filmando show da banda last bones">
